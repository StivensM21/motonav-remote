...
## NAV v2 — навигация с формой дороги (6 + 2·N байт)

Страница шлёт раз в секунду. Байт 0 = 2 отличает новый формат от старого
10-байтового (v1, байт 0 = 1) — прошивка понимает оба.

| Байт | Значение |
|---|---|
| 0 | версия протокола = 2 |
| 1 | манёвр: 0 прямо, 1 направо, 2 налево, 3 круг, 4 разворот, 5 финиш |
| 2–3 | метров до манёвра, uint16 LE |
| 4 | скорость, км/ч |
| 5 | N — число точек дороги (0–16) |
| 6… | N пар int8: (x, y) — форма маршрута впереди в пикселях экрана, относительно якоря-шеврона; x вправо, y вперёд по курсу; масштаб 0.45 px/м (~450 м обзора) |
